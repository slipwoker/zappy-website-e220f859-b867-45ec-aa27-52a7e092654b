document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!fullName || !email || !phone || !userType || !terms) {
        alert('נא למלא את כל השדות הנדרשים ולאשר את תנאי השימוש.');
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רפואה פונקציונלית ישראל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e220f859-b867-45ec-aa27-52a7e092654b',
                    name: data.name || '',
                    email: data.email || '',
